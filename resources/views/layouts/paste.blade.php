        ...
        <div class="d-flex text-body-secondary pt-3">
            ...
            <p class="pb-3 mb-0 small lh-sm border-bottom"  style="width: 100vw">
                <strong class="d-block text-gray-dark">
                    {{ $paste->paste_name }}
                    <ya-tr-span class="ml-3" data-translated="true" data-source-lang="en" data-target-lang="ru" style="visibility: inherit !important;"> {{ $paste->getRemainingTime() }} </ya-tr-span>
                </strong>
                ...
                <ya-tr-span data-index="20-1" data-translated="true" data-source-lang="en" data-target-lang="ru" style="visibility: inherit !important;"> {{ $paste->paste_format }} </ya-tr-span>
            </p>
        </div>
    @endforeach
